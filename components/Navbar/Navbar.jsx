...
function Navbar() {
  ...
  return (
    <header className={`bg-white fixed top-0 right-0 left-0 z-50 ${isScrolled ? 'drop-shadow-[0_4px_25px_rgba(0,0,0,0.1)]' : ''}`}>
        <nav className='max-w-[1400px] max-auto px-10 md:h-[14vh] h-[12vh] flex justify-between items-center '>
            {/* logo */}
            <Link to="/" className='text-3xl font-bold'>
                green<span className='text-orange-500 uppercase'>Veg</span>
            </Link> 
          ...
          <ul className='md:flex items-center gap-x-15 hidden'>
            ...
            <li>
                <a to="#"className='font-semibold tracking-wider text-zinc-800 hover:text-orange-500'>About Us</a>
            </li>
            <li>
          ...
          <div className='flex items-center gap-x-5'>
            ...
            <div className='md:flex  p-1 border-2 border-orange-500 rounded-full hidden'>
                ...
                <button className='bg-gradient-to-b from-orange-400 to-orange-500 text-white w-10 flex justify-center items-center rounded-full text-xl'>
                   <FaSearch />
                </button>
            </div>
